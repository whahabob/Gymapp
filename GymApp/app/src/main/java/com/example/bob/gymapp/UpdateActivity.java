...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCursor != null)
            mCursor.moveToFirst();
        mReminderView.setText(mCursor.getString(mCursor.getColumnIndex(RemindersContract.ReminderEntry.COLUMN_NAME_WORKOUT)));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(updatedReminderText)) {
                    ...
                    values.put(RemindersContract.ReminderEntry.COLUMN_NAME_WORKOUT,updatedReminderText);
                    Uri singleUri = ContentUris.withAppendedId(RemindersProvider.CONTENT_URI,mID);
